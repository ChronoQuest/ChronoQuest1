...
public class PlayerHealth : MonoBehaviour, IRewindable
{
        ...
        public void OnStartRewind()
    {
        ...
        // clear queued Die trigger so it doesnt fire after rewind ends. if R is pressed
        // on the killing-hit frame the trigger sits queued and replays Player_Death the
        // moment we restore speed=1
